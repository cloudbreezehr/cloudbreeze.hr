...
const overrides = {
  ...
  // ── Combo hybrids (see themes/alchemy.js) ──
  // Resolved under "combo:<id>" when a curated theme pair is stacked.
  "combo:cryo-code": {
    dark: {
      clickColor: [120, 255, 210],
      orbitColor: [90, 245, 200],
      trailColor: [110, 235, 210],
      starColor: [160, 255, 220],
      streakColor: [80, 220, 190],
      moteColor: [140, 255, 220],
      moteGlow: [60, 220, 170],
      lightningColor: [160, 255, 230],
      lightningShadow: [90, 240, 200, 0.8],
      lightningFlash: [200, 255, 240],
      auroraHueBase: 150,
      auroraHueRange: 40,
    },
    light: {
      clickColor: [0, 190, 150],
      orbitColor: [0, 200, 160],
      trailColor: [30, 190, 160],
      starColor: [120, 230, 200],
      streakColor: [40, 190, 160],
      moteColor: [0, 190, 150],
      moteGlow: [0, 160, 120],
      lightningColor: [160, 255, 230],
      lightningShadow: [90, 240, 200, 0.8],
  ...
  "combo:signal-noir": {
    dark: {
      clickColor: [190, 200, 190],
      orbitColor: [170, 185, 175],
      trailColor: [160, 180, 170],
      starColor: [200, 215, 205],
      streakColor: [150, 170, 160],
      moteColor: [180, 200, 190],
      moteGlow: [130, 160, 145],
      lightningColor: [210, 230, 215],
      lightningShadow: [160, 190, 170, 0.8],
      lightningFlash: [225, 240, 230],
      auroraHueBase: 100,
      auroraHueRange: 30,
    },
    light: {
      clickColor: [110, 130, 120],
      orbitColor: [100, 125, 112],
      trailColor: [95, 120, 108],
      starColor: [150, 170, 160],
      streakColor: [100, 125, 112],
      moteColor: [110, 130, 120],
      moteGlow: [80, 105, 92],
      lightningColor: [210, 230, 215],
      lightningShadow: [160, 190, 170, 0.8],
      lightningFlash: [225, 240, 230],
  ...
  "combo:storyboard": {
    dark: {
      clickColor: [255, 150, 60],
      orbitColor: [245, 170, 90],
      trailColor: [235, 160, 80],
      starColor: [250, 220, 170],
      streakColor: [220, 150, 80],
      moteColor: [245, 190, 120],
      moteGlow: [220, 140, 60],
      lightningColor: [255, 200, 130],
      lightningShadow: [235, 150, 70, 0.8],
      lightningFlash: [255, 230, 190],
      auroraHueBase: 30,
      auroraHueRange: 25,
    },
    light: {
      clickColor: [220, 110, 30],
      orbitColor: [210, 125, 50],
      trailColor: [200, 115, 45],
      starColor: [210, 160, 100],
      streakColor: [190, 115, 50],
      moteColor: [220, 140, 60],
      moteGlow: [190, 105, 35],
      lightningColor: [255, 200, 130],
      lightningShadow: [235, 150, 70, 0.8],
      lightningFlash: [255, 230, 190],
